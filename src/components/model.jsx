        ...
        <section className='common-padding'>
            <div className='screen-max-width'>
                ...
                <div className="flex flex-col items-center mt-5">
                    <div className="w-full h-[75vh] overflow-hidden relative"></div>
                    <ModelView
                        index={1}
                        groupRef={small}
                        gsapType="view1"
            ...
            <div className="mx-auto w-full">
                <p className="text-sm font-light text-center my-5">{model.title}</p>
                <div className="flex-center">
                    ...
                    <button className="size-btn-container">
                        {sizes.map(({ label, value }) => (
                            <span
                                key={label}
                                className="size-btn" style={{ backgroundColor: size === value ? 'white' : 'transparent', color: size !== value ? 'white' : 'black' }}
